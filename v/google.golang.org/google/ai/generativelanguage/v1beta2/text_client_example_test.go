...
func ExampleTextClient_GenerateText() {
	...
	req := &generativelanguagepb.GenerateTextRequest{
		...
		// See https://pkg.go.dev/google.golang.org/genproto/googleapis/ai/generativelanguage/v1beta2#GenerateTextRequest.
	}
...
func ExampleTextClient_EmbedText() {
	...
	req := &generativelanguagepb.EmbedTextRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/google.golang.org/genproto/googleapis/ai/generativelanguage/v1beta2#EmbedTextRequest.
	}
