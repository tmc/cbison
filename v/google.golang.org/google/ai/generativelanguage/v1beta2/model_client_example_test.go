...
func ExampleModelClient_GetModel() {
	...
	req := &generativelanguagepb.GetModelRequest{
		...
		// See https://pkg.go.dev/google.golang.org/genproto/googleapis/ai/generativelanguage/v1beta2#GetModelRequest.
	}
...
func ExampleModelClient_ListModels() {
	...
	req := &generativelanguagepb.ListModelsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/google.golang.org/genproto/googleapis/ai/generativelanguage/v1beta2#ListModelsRequest.
	}
